                ...
                :class="{
                    'text-gray-500':!$route.path.includes('/products/new'),
                         'text-white':$route.path.includes('/products/new'),
                                       ...
                                       'cursor-pointer':true}">
                                       <template v-slot:icon-word>
                                           <div class="flex items-center justify-start overflow-hidden [y-2">
                                            <i class="fas fa-coffee ml-6 mr-4"></i>
                                            <label class=" flex-shrink-0 ml-2 text-sm font-sans tracking-wide cursor-pointer">New Product</label>
                                            </div>
